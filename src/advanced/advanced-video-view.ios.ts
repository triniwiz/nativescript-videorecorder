...
export class AdvancedVideoView extends AdvancedVideoViewBase {
  ...
  private openCamera(): void {
    try {
      ...
      let input: AVCaptureDeviceInput = (<any>(
        AVCaptureDeviceInput
      )).deviceInputWithDeviceError(device, null);

      let audioDevice = AVCaptureDevice.defaultDeviceWithMediaType(
        AVMediaTypeAudio
      );
      let audioInput: AVCaptureDeviceInput = (<any>(
        AVCaptureDeviceInput
      )).deviceInputWithDeviceError(audioDevice, null);
